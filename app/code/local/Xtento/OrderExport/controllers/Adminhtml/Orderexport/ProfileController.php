 ...
 * Last Modified: 2014-09-02T15:21:30+02:00
...
class Xtento_OrderExport_Adminhtml_OrderExport_ProfileController extends Xtento_OrderExport_Controller_Abstract
{
    ...
    public function editAction()
    {
        ...
        if ($model->getCronjobEnabled() && $model->getExportOneFilePerObject() && $model->getXslTemplate() != '' && !preg_match("/%lastincrementid%/", $model->getXslTemplate()) && !preg_match("/%lastentityid%/", $model->getXslTemplate()) && !preg_match("/%lastorderincrementid%/", $model->getXslTemplate())) {
