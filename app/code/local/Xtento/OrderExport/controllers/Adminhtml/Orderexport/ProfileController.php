 ...
 * Last Modified: 2014-07-11T14:23:11+02:00
...
class Xtento_OrderExport_Adminhtml_OrderExport_ProfileController extends Xtento_OrderExport_Controller_Abstract
{
    ...
    public function editAction()
    {
        ...
        if ($model->getCronjobEnabled() && $model->getExportOneFilePerObject() && $model->getXslTemplate() != '' && !preg_match("/%lastincrementid%/", $model->getXslTemplate()) && !preg_match("/%lastentityid%/", $model->getXslTemplate())) {
