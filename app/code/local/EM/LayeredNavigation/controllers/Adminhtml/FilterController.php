...
class EM_LayeredNavigation_Adminhtml_FilterController extends Mage_Adminhtml_Controller_Action {
	protected function _initAction() {
		$this->loadLayout()->_setActiveMenu('layerednavigation/items')->_addBreadcrumb(Mage::helper('adminhtml')->__('Layered Navigation Filters'), Mage::helper('adminhtml')->__('Layered Navigation Filters'));
		return $this;
	}
