...
class Nano_Pos_Block_Adminhtml_Pos_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('bank_test_url', 'text', array(
            'label'     => Mage::helper('pos')->__('Bank Test Url'),
            'required'  => true,
            'name'      => 'bank_test_url',
        ));

        $fieldset->addField('bank_username', 'text', array(
            'label'     => Mage::helper('pos')->__('Bank Username'),
            'required'  => true,
            'name'      => 'bank_username',
        ));

        $fieldset->addField('bank_pw', 'text', array(
            'label'     => Mage::helper('pos')->__('Bank Password'),
            'required'  => true,
            'name'      => 'bank_pw',
        ));
